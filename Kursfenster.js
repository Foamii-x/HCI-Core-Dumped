...
uploadSections.forEach((section) => {
    ...
    const isBeforeStart =false;//currentDate < period.startDate;
    const isAfterEnd = false;//currentDate > period.endDate;
    const isInProgress = true;//!isBeforeStart && !isAfterEnd;
